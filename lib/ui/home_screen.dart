...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget handleResponsiveness(state) {
    Widget earningWidget = Text("Earning \nof the day",
        textAlign: TextAlign.center,
        style: TextStyle(
          color: Colors.white,
        ));
    ...
    if (state is EarningSuccessState) {
      double totalSale = state.earningDataResponse.data.cashSale +
          state.earningDataResponse.data.onlineSale +
          state.earningDataResponse.data.khataSale;
      earningWidget = Column(
        mainAxisAlignment: MainAxisAlignment.center,
        children: <Widget>[
          Text(
                          ...
                          child: Center(
                            ...
                            children: <Widget>[
                              ...
                              Padding(
                                padding: const EdgeInsets.only(top: 8.0),
                                child: Text(
                                  "TODAY\n${TimeOfDay.fromDateTime(state.orderFetchResponse.data.orders[index].createdOn).format(context)} ",
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                                    color: Colors.white,
                                  ),
